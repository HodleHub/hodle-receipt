      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <Text style={styles.fieldValue}>{amount} {amount === 1 ? 'sat' : 'sats'}</Text>
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <Text style={[styles.fieldValue, isPaid ? styles.statusPaid : styles.statusUnpaid]}>
